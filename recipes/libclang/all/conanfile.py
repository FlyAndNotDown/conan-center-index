...
class LibclangConan(ConanFile):
    ...
    def generate(self):
        ...
        cmake_toolchain.cache_variables["LLVM_ENABLE_PIC "] = "OFF"
        cmake_toolchain.cache_variables["LLVM_BUILD_STATIC"] = "ON"
        cmake_toolchain.cache_variables["LIBCLANG_BUILD_STATIC"] = "ON"
